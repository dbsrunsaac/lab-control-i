...
figure;
plot(t, response, 'b', 'DisplayName', 'Respuesta al escalón');
hold on;
plot(t_line, y_line, 'r--', 'DisplayName', 'Línea tangente');
plot(t_tangent, y_tangent, 'ro', 'DisplayName', 'Punto de tangencia');
